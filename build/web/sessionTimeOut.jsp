    ...
    <body>
                ...
                <div class="navbar navbar-default">
                    ...
                    <div>
                        <ul class="nav navbar-nav navbar-right navbar-collapse collapse top-2">
                            ...
                            <li><a href="contact-us.html" class="img-circle">Contact Us</a>
                            </li>
        ...
        <div id="body">
            ...
            <div class="container">
                ...
                <h1>The system is taking too long to send the email (Session has timed out please login again)<br>You have been logged out to maintain data integrity</h1>
                <form class="form-inline" action="index.html"><input name="selection" type="submit" value="Proceed" class="btn btn-primary"></form>
