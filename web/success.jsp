    ...
    <body>
        ...
        <div id="body">
            <div class="breadcrumbs margin-bottom-20">
                <div class="container">
                    <h1 class="color-green pull-left">LOGIN ERROR</h1>
                </div>
                <!--/container-->
            </div>
            <!--/breadcrumbs-->
            <div class="container">
                <div class="row blog-page">
                    <div class="headline"><h1>Project Created</h1></div>
                   
                <p>
                   <em><h1></h1>
                <form class="form-inline" action="management.do.system"><input name="selection" type="submit" value="Proceed" class="btn btn-primary"></form>
            </p>
                <br><br>
                </div>
                <!--/container-->
